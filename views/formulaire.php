...
?>
    ...
    <form class="space-y-4 md:space-y-6" id="form" method="post" action="store.php">
                        <div>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="inscrire.html" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</a>
                        </p>
                    </form> 
    </div></div></div></section>
